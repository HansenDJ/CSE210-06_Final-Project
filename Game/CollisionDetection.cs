...
{
    private int actualX1 = 0;   // Character1's collider box x coordinate
    private int actualY1 = 0;   // Character1's collider box y coordinate
    private int actualX2 = 0;   // Character2's collider box x coordinate
    private int actualY2 = 0;   // Character2's collider box y coordinate
    Player player = new();
